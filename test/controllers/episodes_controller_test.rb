...
class EpisodesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create episode" do
    assert_difference('Episode.count') do
      post episodes_url, params: { episode: { published: @episode.published, title: @episode.title, url: @episode.url } }
    end
  ...
  test "should update episode" do
    patch episode_url(@episode), params: { episode: { published: @episode.published, title: @episode.title, url: @episode.url } }
